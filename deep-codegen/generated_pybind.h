inline void export_kernel(py::module &m) { 
    m.def("spmmv",[](py::capsule& input, py::capsule& output, py::capsule& rowPtr, py::capsule& colInd, py::capsule& values, py::capsule& degrees, int V, int F_in){
    ...
    return spmmv(input_array, output_array, rowPtr_array, colInd_array, values_array, degrees_array, V, F_in);
    }
  );
}